...
-- select : owner/manager voient tout ; les autres rôles ne voient que les
-- tâches de l'employé auquel leur compte est lié (même règle que
-- employee_shifts/employee_reviews, cf. 0012_employee_self_service_rls.sql).
