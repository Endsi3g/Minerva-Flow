...
export const NAV_ITEMS: SearchableNavItem[] = [
  ...
  { key: "retentionFunnel", href: "/reports/retention-funnel", title: "Entonnoir de rétention", subtitle: "Cycle de vie, 10 KPI clés et attribution des campagnes", roles: allRoles },
