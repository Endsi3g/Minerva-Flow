...
export const NAV_ITEMS: SearchableNavItem[] = [
  ...
  { key: "impact", href: "/impact", title: "Impact", subtitle: "Ce que la fidélisation vous rapporte, et qui relancer", roles: managerRoles },
  ...
  { key: "days", href: "/days", title: "Journées", subtitle: "Suivi des performances journalières", roles: allRoles },
  { key: "reports", href: "/reports", title: "Rapports", subtitle: "Seuil de rentabilité, food cost, journées", roles: allRoles },
  { key: "maps", href: "/maps", title: "Cartes", subtitle: "Zones de livraison et couverture", roles: allRoles },
  { key: "programs", href: "/programs", title: "Programmes", subtitle: "Programmes de fidélité et d'opérations", roles: allRoles },
  { key: "library", href: "/library", title: "Bibliothèque", subtitle: "Documents et ressources partagées", roles: allRoles },
