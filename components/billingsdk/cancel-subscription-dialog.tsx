...
export interface CancelSubscriptionDialogProps {
  ...
  // Renders no trigger button at all when omitted — lets a caller drive the
  // dialog entirely via the controlled open/onOpenChange pair below (added
  // on top of the upstream Billing SDK component, which only supported an
  // uncontrolled internal open state behind its own trigger button).
  hideTrigger?: boolean;
  open?: boolean;
