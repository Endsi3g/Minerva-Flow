...
const TextualFilePreviewCard: React.FC<{
  ...
  return (
    <div className="bg-[#FAF8F5] border border-[#E2E0D8] relative rounded-xl p-3 size-[125px] shadow-xs shrink-0 overflow-hidden text-left">
...
const FilePreviewCard: React.FC<{
  ...
  return (
    <div
      className={cn(
        "relative group bg-[#FAF8F5] border border-[#E2E0D8] rounded-xl size-[125px] shadow-xs shrink-0 overflow-hidden text-left",
        isImage ? "p-0" : "p-3"
      )}
    >
...
// Main ClaudeChatInput (100% Light Solid Style)
