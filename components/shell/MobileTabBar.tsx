...
import { LayoutGrid, Sparkles, Database, FileBarChart2, Users } from "lucide-react";
...
const tabs: TabItem[] = [
  ...
  { href: "/settings", label: "Équipe", icon: Users },
];
...
export function MobileTabBar() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 flex h-16 items-stretch border-t border-mv-border bg-mv-cream-soft/95 backdrop-blur-sm md:hidden">
      {tabs.map((tab) => {
