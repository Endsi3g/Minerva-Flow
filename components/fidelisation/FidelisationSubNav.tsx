...
import { Users, Share2, Gift, QrCode, Settings, MapPin, BarChart3, Trophy } from "lucide-react";
...
const SECTIONS = [
  ...
  { href: "/fidelisation/resultats", label: "Résultats", icon: Trophy, managerOnly: true },
