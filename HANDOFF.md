...
- Le worktree principal contient maintenant des changements non commités d’une autre phase (`MenuPriceOptionsEditor`, migration 0151 et modifications web/iOS). Ils ont été préservés et exclus du commit `d5f9b76`; ne pas les inclure par `git add -A` sans revue explicite.
